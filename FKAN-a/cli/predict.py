...
def add_args(parser: ArgumentParser):
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        default="./models/FKAN_BindingDB.pt",
        help="Path to the file containing the model to use for predictions. Default: ./models/FKAN_BindingDB.pt",
    )
    parser.add_argument(
        "--outfile",
        type=str,
...
def main(args):
    ...
    logg.info(f"Printing FKAN results to {args.outfile}")
